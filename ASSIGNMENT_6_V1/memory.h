 ...
 * ============================================================
 *
 * Lab 6 stores page-table entries directly in reserved physical
 * memory (Frame 0).  The separate simulator-side pageTable array
 * is intentionally removed.
 *
 * Each entry is one byte: 0 means unmapped, while 1..15 are
 ...
 *
 * A previously defined page may be paged in from swap on demand.
 * ============================================================
 */
