...
/*
 * Page Table Base Register.  For a running task, PTBR[p] contains
 * the physical byte address of the first page-table entry for the
 * task currently assigned to processor p.  A negative value means
 * that the processor currently has no task mapped.
 */
extern int PTBR[NP];
...
/* Flush buffered Print output for the process on this processor. */
