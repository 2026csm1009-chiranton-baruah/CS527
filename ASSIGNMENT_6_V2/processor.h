...
/*
 * Page Table Base Register.  It contains the physical byte
 * address of the first page-table entry for the task currently
 * mapped to each processor.
 */
extern int PTBR[NP];
...
/* Return the execution count for one byte-code instruction. */
uint64_t get_instruction_execution_count(int proc_id,
